	...
	<div class="search">
		<form method="get"
			...
			<span>供应商名称：</span> <input name="queryProName" type="text"
				...
				id="searchbutton"> <a
				href="${pageContext.request.contextPath }/sys/provider/addProvider.html">添加供应商</a>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/statics/js/provider/providerlist.js"></script>
